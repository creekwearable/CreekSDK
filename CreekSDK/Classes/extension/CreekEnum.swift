...
public enum SportType: Int, Codable {
   ...
   case SAILBOARD = 75              // Sailboarding
   case FOLDBOATING = 76            // Folding boat
   case CANOEING = 77               // Canoeing
   case BOAT_RACE = 78              // Boat race
   ...
   case AUSTRALIAN_RULES_FOOTBALL = 116 // Australian football
   ...
   case REHEALTHY_TRAINING = 144    // Recovery training
   case MULTISPORT = 145            // Multisport
   ...
   case SKATEBOARDING = 158         // Kick scooter
   ...
   case FOLK_DANCING = 167          // Folk dancing
   ...
   case HOT_AIR_BALLOON = 173       // Hot air ballooning
   ...
   case CALLISTHENICS = 185          // Callisthenics
