...
public struct protocol_remind_mark_switch_operate: Sendable {
  ...
  ///EDA压力过高提醒开关
  public var edaHighStressSwitch: switch_type = .switchNull
...
extension protocol_remind_mark_switch_operate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    13: .standard(proto: "eda_high_stress_switch"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 13: try { try decoder.decodeSingularEnumField(value: &self.edaHighStressSwitch) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.edaHighStressSwitch != .switchNull {
      try visitor.visitSingularEnumField(value: self.edaHighStressSwitch, fieldNumber: 13)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  public static func ==(lhs: protocol_remind_mark_switch_operate, rhs: protocol_remind_mark_switch_operate) -> Bool {
    ...
    if lhs.edaHighStressSwitch != rhs.edaHighStressSwitch {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension protocol_remind_switch_inquire_reply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    14: .standard(proto: "eda_high_stress_switch"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 14: try { try decoder.decodeSingularEnumField(value: &self.edaHighStressSwitch) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.edaHighStressSwitch != .switchNull {
      try visitor.visitSingularEnumField(value: self.edaHighStressSwitch, fieldNumber: 14)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
