...
public struct protocol_app_list_operate {
...
public struct protocol_app_list_inquire_reply {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension protocol_app_list_operate: @unchecked Sendable {}
extension protocol_app_list_inquire_reply: @unchecked Sendable {}
