...
public struct protocol_function_table: @unchecked Sendable {
  ...
  ///是否选择用勿扰定时开关设置
  public var disturbSwitch: function_table {
    get {return _storage._disturbSwitch ?? function_table()}
    set {_uniqueStorage()._disturbSwitch = newValue}
  }
  /// Returns true if `disturbSwitch` has been explicitly set.
  public var hasDisturbSwitch: Bool {return _storage._disturbSwitch != nil}
  /// Clears the value of `disturbSwitch`. Subsequent reads from it will return its default value.
  public mutating func clearDisturbSwitch() {_uniqueStorage()._disturbSwitch = nil}

  ///是否支持飞行模式
  public var airplaneMode: function_table {
    get {return _storage._airplaneMode ?? function_table()}
    set {_uniqueStorage()._airplaneMode = newValue}
  }
  /// Returns true if `airplaneMode` has been explicitly set.
  public var hasAirplaneMode: Bool {return _storage._airplaneMode != nil}
...
extension protocol_function_table: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._disturbSwitch {
