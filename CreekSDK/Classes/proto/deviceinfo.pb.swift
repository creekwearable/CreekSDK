...
public struct protocol_device_batt_info {
...
public struct device_voice_assistant {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension protocol_device_batt_info: @unchecked Sendable {}
extension protocol_bt_name: @unchecked Sendable {}
extension device_size_info: @unchecked Sendable {}
extension hardware_support: @unchecked Sendable {}
extension device_sn_info: @unchecked Sendable {}
extension device_voice_assistant: @unchecked Sendable {}
extension protocol_device_info: @unchecked Sendable {}
