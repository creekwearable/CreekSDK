...
public struct protocol_zs_weather_future_item: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  ///1bytes 天气类型
  public var weatherType: zs_weather_type = .zsSunny
...
public struct protocol_zs_weather_hour_weather_item: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///日出日落时间item
public struct protocol_zs_weather_sunrise_item: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///月出月落时间item
public struct protocol_zs_weather_moon_item: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct protocol_zs_weather_detail_data_item: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///1bytes 天气类型
  public var weatherType: zs_weather_type {
  ...
  ///max:48 实时天气数据，单位小时
  public var hoursWeatherItems: [protocol_zs_weather_hour_weather_item] {
  ...
  ///未来天气数据 暂定7天
  public var futureItems: [protocol_zs_weather_future_item] {
    get {return _storage._futureItems}
    set {_uniqueStorage()._futureItems = newValue}
  }

  ///日出日落时间item
  public var sunriseItem: protocol_zs_weather_sunrise_item {
    get {return _storage._sunriseItem ?? protocol_zs_weather_sunrise_item()}
  ...
  ///max：3 月出月落时间item 3天
  public var moonItem: [protocol_zs_weather_moon_item] {
    get {return _storage._moonItem}
    set {_uniqueStorage()._moonItem = newValue}
  }

  ///max：3 日出日落时间item 3天
  public var sunriseItems: [protocol_zs_weather_sunrise_item] {
...
public struct protocol_zs_weather_operate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var detailDataItem: [protocol_zs_weather_detail_data_item] = []
...
public struct protocol_zs_weather_inquire_reply: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension protocol_zs_weather_future_item: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "protocol_zs_weather_future_item"
  ...
  public static func ==(lhs: protocol_zs_weather_future_item, rhs: protocol_zs_weather_future_item) -> Bool {
...
extension protocol_zs_weather_hour_weather_item: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "protocol_zs_weather_hour_weather_item"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "weather_type"),
  ...
  public static func ==(lhs: protocol_zs_weather_hour_weather_item, rhs: protocol_zs_weather_hour_weather_item) -> Bool {
    if lhs.weatherType != rhs.weatherType {return false}
...
extension protocol_zs_weather_sunrise_item: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "protocol_zs_weather_sunrise_item"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: protocol_zs_weather_sunrise_item, rhs: protocol_zs_weather_sunrise_item) -> Bool {
...
extension protocol_zs_weather_moon_item: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "protocol_zs_weather_moon_item"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: protocol_zs_weather_moon_item, rhs: protocol_zs_weather_moon_item) -> Bool {
...
extension protocol_zs_weather_detail_data_item: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "protocol_zs_weather_detail_data_item"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "month"),
    2: .same(proto: "day"),
    3: .same(proto: "hour"),
  ...
  fileprivate class _StorageClass {
    ...
    var _min: UInt32 = 0
    var _week: UInt32 = 0
    var _weatherType: zs_weather_type = .zsSunny
    var _curTemp: Int32 = 0
    var _curMaxTemp: Int32 = 0
    var _curMinTemp: Int32 = 0
    var _cityName: Data = Data()
    var _hoursWeatherItems: [protocol_zs_weather_hour_weather_item] = []
    ...
    var _futureItems: [protocol_zs_weather_future_item] = []
    var _sunriseItem: protocol_zs_weather_sunrise_item? = nil
    var _location: Bool = false
    var _atmosHpa: UInt32 = 0
    var _uvItems: [UInt32] = []
    var _moonItem: [protocol_zs_weather_moon_item] = []
    var _sunriseItems: [protocol_zs_weather_sunrise_item] = []
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._weatherType != .zsSunny {
  ...
  public static func ==(lhs: protocol_zs_weather_detail_data_item, rhs: protocol_zs_weather_detail_data_item) -> Bool {
...
extension protocol_zs_weather_operate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "protocol_zs_weather_operate"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: protocol_zs_weather_operate, rhs: protocol_zs_weather_operate) -> Bool {
...
extension protocol_zs_weather_inquire_reply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = "protocol_zs_weather_inquire_reply"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: protocol_zs_weather_inquire_reply, rhs: protocol_zs_weather_inquire_reply) -> Bool {
