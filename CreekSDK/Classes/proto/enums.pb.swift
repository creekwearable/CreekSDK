...
public enum event_id2: SwiftProtobuf.Enum {
    public typealias RawValue = Int
    case null // = 0
...
extension event_id2: CaseIterable {
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    public static var allCases: [event_id2] = [
        .null,
        .musicControl,
        .findPhone,
        .syncData,
...
extension event_id2: @unchecked Sendable {}
...
extension event_id2: SwiftProtobuf._ProtoNameProviding {
    public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
